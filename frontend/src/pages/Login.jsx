...
const Login = () => {
  ...
  const handleDemoLogin = () => {
    setForm({ email: 'recruiter@gmail.com', password: 'recruiter123456' });
  };
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold">
              Welcome back to <span className="gradient-text">StudyNest AI</span>
            </h1>
          ...
          <div className="glass rounded-2xl border border-indigo-500/15 p-8"
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative flex items-center gap-3">
                ...
                <span className="text-slate-600 text-xs">Demo Account</span>
                <div className="flex-1 h-px bg-white/5" />
              </div>
